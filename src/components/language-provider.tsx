...
const translations: Translations = {
  ru: {
    ...
    "badges.product": "Продукт",
    "badges.mirror": "Зеркало",
    "badges.seo": "SEO-сателлит",
    "badges.subdomain": "Поддомен",
    "badges.referral": "Реферальный",
    "badges.redirect": "Редиректор",
    "badges.technical": "Технический",
    "badges.b2b": "B2B",
  ...
  en: {
    ...
    "badges.seo": "SEO Satellite",
    "badges.subdomain": "Subdomain",
    "badges.referral": "Referral",
    "badges.redirect": "Redirect",
    "badges.technical": "Technical",
    "badges.b2b": "B2B",
