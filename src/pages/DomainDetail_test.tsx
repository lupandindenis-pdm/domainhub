        ...
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              <h1 
                className="text-3xl font-bold font-mono tracking-tight cursor-pointer text-primary transition-colors"
                onClick={() => {
                  try {
              ...
              <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 text-muted-foreground text-foreground"
          ...
          <div className="w-full">
            <div className="p-6 space-y-8">
              ...
              <div className="grid gap-8 md:grid-cols-2">
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input value={domain.project} readOnly className="bg-muted/50 text-base hover:bg-muted/50 cursor-default" />
                  </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input value={domain.department} readOnly className="bg-muted/50 text-base hover:bg-muted/50 cursor-default" />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                 ...
                 <div className={cn(
                   "w-full rounded-md bg-muted/30 px-3 py-2 text-sm",
                    ...
                    <div>
                       {domain.programLink && (
                         <div className="p-4 bg-secondary rounded-lg flex flex-col gap-2">
                           ...
                           <a href={domain.programLink} target="_blank" rel="noreferrer" className="text-primary underline break-all text-sm">
                             {domain.programLink}
                           </a>
                         </div>
                       )}
...
function DetailRow({ label, value }: { label: string, value: React.ReactNode }) {
  return (
    <div className="grid grid-cols-[1fr_1.5fr] items-center py-4 px-6 gap-4 bg-muted/30 transition-colors">
    ...
    <div className="flex items-center justify-between py-1">
      ...
      <div className="flex items-center gap-2 font-medium text-sm text-right">
        {isLink && typeof value === 'string' ? (
           <a href={value.startsWith('http') ? value : `https://${value}`} target="_blank" rel="noreferrer" className="text-primary underline flex items-center gap-1">
...
function ReadOnlyGeoView({ 
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex flex-wrap items-center gap-1 min-h-10 py-2 px-3 rounded-md bg-muted/30">
        {selected.length > 0 ? (
          <>
            {visible.map((val) => (
              <div 
            ...
            {hasHidden && (
              <Popover>
                <PopoverTrigger asChild>
                  <div className="font-mono text-xs px-2 py-1 rounded-md cursor-pointer bg-muted/50">
                    +{hidden.length}
                  </div>
                </PopoverTrigger>
...
�D �D�E*cascade08
�E�T �T�T*cascade08�T�� ���� *cascade08���� "(f6033132e6de1ee2f3f965a7eb666f1cf9ea58c92^file:///d:/%D0%A0%D0%B0%D0%B1%20%D1%81%D1%82%D0%BE%D0%BB/domain-hub/src/pages/DomainDetail.tsx:Cfile:///d:/%D0%A0%D0%B0%D0%B1%20%D1%81%D1%82%D0%BE%D0%BB/domain-hub
